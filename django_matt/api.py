...
from django_matt.openapi.docs import get_swagger_ui, get_redoc, get_openapi_json
...
class MattAPI(APIRouter):
    ...
    def get_urls(self) -> list:
        ...
        if self.docs_url:
            ...
            url_patterns.append(
                path(self.docs_url.lstrip("/"), docs_view, name="swagger-ui")
            )
        ...
        if self.redoc_url:
            ...
            url_patterns.append(
                path(self.redoc_url.lstrip("/"), redoc_view, name="redoc")
            )
