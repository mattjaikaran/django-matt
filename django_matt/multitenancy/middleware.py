...
class TenantMiddleware:
    ...
    def _resolve_from_user(self, request: HttpRequest, Organization, Membership) -> Optional["Organization"]:
...
class TenantMiddlewareAsync:
    ...
    async def _resolve_from_header(self, request: HttpRequest, Organization) -> Optional["Organization"]:
        """Resolve tenant from request headers."""
        from asgiref.sync import sync_to_async
    ...
    async def _resolve_from_session(self, request: HttpRequest, Organization) -> Optional["Organization"]:
        """Resolve tenant from session."""
        from asgiref.sync import sync_to_async
    ...
    async def _resolve_from_user(self, request: HttpRequest, Organization, Membership) -> Optional["Organization"]:
        """Resolve tenant from user's memberships."""
        from asgiref.sync import sync_to_async
