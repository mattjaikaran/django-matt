...
class TodoBase(Schema):
    ...
    description: str | None = Field(None, description="A detailed description of the todo item")
...
class Todo(TodoBase):
    ...
    created_at: datetime.datetime = Field(..., description="When the todo item was created")
    updated_at: datetime.datetime | None = Field(None, description="When the todo item was last updated")
